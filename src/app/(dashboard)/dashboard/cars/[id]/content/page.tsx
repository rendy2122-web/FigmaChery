...
import { CarMediaEditor } from "@/components/cms/car-media-editor";
...
export default async function CarContentPage({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Konten Halaman Produk</h1>
